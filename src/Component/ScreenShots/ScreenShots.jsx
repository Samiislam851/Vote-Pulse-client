...
const ScreenShots = () => {
    ...
    const springProps = useSpring({
        ...
        delay: 100,
        reverse: scrollY < 2800, // Change this value to trigger the animation at a different scroll position
    });
    ...
    return (
        <div className='max-w-[1600px] md:px-12 px-8 mx-auto'>
            {/*Create Election  */}
            <div className='md:flex md:flex-row justify-center items-center gap-16 py-10 md:pb-40'>
                ...
                <div className='basis-[50%]'>
                    <animated.div style={springProps2} className={'animated-element'} >
                        <h1 className='md:text-6xl text-3xl text-center md:text-start  font-bold text-gray-600 py-5'> Create an online election in a matter of seconds</h1>
            ...
            <div className='md:flex md:flex-row-reverse justify-center items-center gap-16 pb-20'>
                <div className='basis-[50%]   ' >
                ...
                <div className='basis-[50%]'>
                    <animated.div style={springProps4}>
                        <h1 className='md:text-6xl text-3xl text-center md:text-start  font-bold text-gray-600 py-5'>Managing elections just got easier..!</h1>

...
.then((result) => { 
  ...
  const credential = GithubAuthProvider.credentialFromError(error);
    ...
    return (
        <>
                <button  className="flex items-center border border-white  bg-white  px-2 md:px-8 py-1 md:py-3 rounded-lg font-semibold">
        ...
        <span className='invisible'>Sign In With Github</span>
      </button>
        </>
    );
}
